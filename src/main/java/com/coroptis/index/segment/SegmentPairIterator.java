 ...
 * 
 * TODO remove class, it's just constructor wrapper or builder
 * 
 * @author honza
 *
 * @param <K>
 ...
 *
 */
public class SegmentPairIterator<K, V> {

        private final SegmentFiles<K, V> segmentFiles;
        private final SegmentDeltaCacheController<K, V> deltaCacheController;

        public SegmentPairIterator(final SegmentFiles<K, V> segmentFiles,
