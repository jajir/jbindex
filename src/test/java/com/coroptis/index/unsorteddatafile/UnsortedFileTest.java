...
public class UnsortedFileTest {
    ...
    public void test_in_mem_unsorted_index() throws Exception {
        ...
        final IndexConfiguration<Integer, String> configuration = new IndexConfiguration<>(
                dir, new TypeDescriptorInteger(), new TypeDescriptorString());

        final UnsortedDataFile<Integer, String> unsorted = configuration
