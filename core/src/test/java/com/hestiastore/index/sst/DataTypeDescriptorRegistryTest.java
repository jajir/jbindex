...
public class DataTypeDescriptorRegistryTest {
    ...
    void test_integer_datatypeDescriptor() {
        ...
        assertEquals("com.hestiastore.index.datatype.TypeDescriptorInteger",
                tdInteger);
    }
    ...
    void test_makeInstance_TypeDescriptorString() {
        final TypeDescriptor<String> ss = DataTypeDescriptorRegistry
                .makeInstance(
                        "com.hestiastore.index.datatype.TypeDescriptorString");
    ...
    void test_makeInstance_classIsNotTypeDescriptor() {
        ...
        assertEquals(
                "In class 'com.hestiastore.index.sst.DataTypeDescriptorRegistryTest$MyFaultyTypeDescriptor'"
