...
public class IndexBuilderTest {
        ...
        void test_conf_missing_specific_type_configuration() throws Exception {
                ...
                assertEquals("Configuration for key class 'java.lang.Long' "
        ...
        void test_conf_default_type_configuration() throws Exception {
                ...
                final IndexConfiguration conf = index.getConfiguration();
                assertEquals(500_000L, conf.getMaxNumberOfKeysInSegmentCache());
                assertEquals(10_000_000, conf
        ...
        void test_custom_conf_disk_reading_cache_size_in_not_1024()
                ...
                assertEquals("Parameter 'diskIoBufferSize' vith value '1000' "
                ...
                final Exception ex = assertThrows(
                                ...
                                () -> Index.<Long, String>builder() //
                                                ...
                                                .withBloomFilterIndexSizeInBytes(
                                                                0)//
                                                .build());
                assertEquals("Max number of segments in "
                                + "cache must be at least 2.", ex.getMessage());
        }
